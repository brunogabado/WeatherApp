...
import { FormCard, FormContainer, CloseButton, FormStyledTitleLogo, FormInput, LinkLabel, Link, SubmitButton, ErrorMessage, SuccessMessage, LogoContainerForm, FormProps } from './RegisterModalForm';
